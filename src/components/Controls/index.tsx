...
type Props = {
  ...
  isLoading: boolean;
  pieces: { currentPosition: number | null }[];
};
...
const Controls = ({ 
  ...
  const hasPlacedPieces = pieces.some(piece => piece.currentPosition !== null);
  ...
  return (
    <div>
      ...
      <ConfirmDialog
        ...
        onConfirm={onReset}
        title="Mulai Ulang Puzzle?"
        message="Apakah Anda yakin ingin memulai ulang puzzle? Semua progress akan hilang."
      />
    </div>
  );
};
